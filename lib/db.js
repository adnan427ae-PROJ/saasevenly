...
// A showcase instance (NEXT_PUBLIC_DEMO_MODE=1) has no accounts, so it has
// nothing to store. Ignoring DATABASE_URL there means the public demo runs on
// the built-in data in lib/demoData.js: instant, free to host, and impossible
// to break by letting a database lapse. Any configured URL is left untouched
// for whenever the instance is switched back to a normal one.
const demoMode = process.env.NEXT_PUBLIC_DEMO_MODE === "1";
const url = demoMode ? null : process.env.DATABASE_URL;
